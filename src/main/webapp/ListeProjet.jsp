...
<div class="container mx-auto bg-white/80 p-6 shadow-lg rounded-lg">
    ...
    <a href="ajouterProjet.jsp" class="bg-transparent border border-blue-500 text-blue-500 px-4 py-2 rounded block w-max mx-auto hover:bg-blue-500 hover:text-white">
        Ajouter un Projet
    </a>
