...
<div class="container mx-auto bg-white/80 p-6 shadow-lg rounded-lg">
    ...
    <h2 class="text-2xl font-bold text-gray-800 text-center mb-10">Liste des Tâches du Projet #<%= id_projet %></h2>

    <!-- Bouton pour ajouter une tâche -->
    <a href="ajouterTache.jsp?id_projet=<%= id_projet %>"
       class="bg-transparent border border-green-500 text-green-500 px-4 py-2 rounded block w-max mx-auto hover:bg-green-500 hover:text-white transition-all duration-300">
        Ajouter une Tâche
    </a>
    ...
    <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mt-10">
        ...
        <div class="group">
            <div class="relative flex flex-col items-center justify-center w-[350px] h-auto max-w-full border border-gray-100 bg-white rounded-lg shadow-lg transition-all duration-500 p-5 transform hover:scale-105 hover:shadow-xl">
                ...
                <p class="text-sm text-gray-600 mt-2 text-center"><strong>Date de début :</strong> <%= tache.getDate_debut() %></p>
